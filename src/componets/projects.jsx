...
export default function Porjects() {
    return (
        <>
            <section id="proyectos" data-section="proyectos" className="pt-20 section undefined scroll-m-20 w-full mx-auto container lg:max-w-4xl md:max-w-2xl" style={{ marginTop: '10%' }}>
                <h2 className="flex items-center mb-6 text-3xl font-semibold gap-x-3 text-black/80 dark:text-white">
                    <svg className="size-7" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" stroke-linejoin="round">
                ...
                <div className="flex flex-col gap-y-16">
                    <article className="flex flex-col space-x-0 space-y-8 group md:flex-row md:space-x-8 md:space-y-0">
                        <div className="w-full md:w-1/2">
                            ...
                            >
                                <img alt="" class="object-cover object-top w-full h-56 transition duration-500 sm:h-full md:scale-110 md:group-hover:scale-105" src="/images/climavista.gif" />
                            </div>
                        </div>
                        <div className="w-full md:w-1/2 md:max-w-lg">
                            <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-100">ClimaVista - Aplicación Meteorológica</h3>
                            <div className="flex flex-wrap mt-2">
                                <ul className="flex flex-row mb-2 gap-x-2">
                                    ...
                                    <li>
                                        <span className="flex gap-x-2 rounded-full text-xs bg-[#003159] text-white py-1 px-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 32 32" fill="#000000">
                                ...
                                <div className="mt-2 text-gray-700 dark:text-gray-400">
                                    Aplicación web que proporciona información meteorológica detallada para una ciudad específica, incluyendo temperatura, pronóstico del clima, velocidad del viento, humedad, cobertura de nubes y entre otros datos.</div>
                                <footer className="flex items-end justify-start mt-4 gap-x-4">
                                    <a
                                        href="https://github.com/justin-campos/ClimaVista-AppMeteorologica"
                                        target='_blank'
                                        role="link"
                    ...
                    <article className="flex flex-col space-x-0 space-y-8 group md:flex-row md:space-x-8 md:space-y-0">
                        <div className="w-full md:w-1/2">
                            <div
                                className="relative flex flex-col items-center col-span-6 row-span-5 gap-8 transition duration-500 ease-in-out transform shadow-xl overflow-clip rounded-xl sm:rounded-xl md:group-hover:-translate-y-1 md:group-hover:shadow-2xl lg:border lg:border-gray-800 lg:hover:border-gray-700 lg:hover:bg-gray-800/50"
                            >
                                <img alt="Unp, universidad politecnica de nicaragua" className="object-cover object-top w-full h-56 transition duration-500 sm:h-full md:scale-110 md:group-hover:scale-105" src="/images/Unpmaps.png" />
                            </div>
                        </div>
                        <div className="w-full md:w-1/2 md:max-w-lg">
                            <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-100">
                                Universidad Nacional Politécnica Maps</h3>
                            <div className="flex flex-wrap mt-2">
                                <ul className="flex flex-row mb-2 gap-x-2">
                                    <li>
                                        <span className="flex gap-x-2 rounded-full text-xs bg-black text-white py-1 px-2">
